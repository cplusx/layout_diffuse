...
class UNetModel(nn.Module):
    ...
    def __init__(
        ...
        print(f'INFO memory efficient is {memory_efficient}')
                ...
                if ds in attention_resolutions:
                    ...
                    layers.append(
                        AttentionBlock(
                            ...
                            ch, num_heads, dim_head, depth=transformer_depth, prompt_dim=prompt_dim, num_prompt=num_prompt, memory_efficient=memory_efficient
                        )
                    )
